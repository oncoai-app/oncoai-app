...
with st.sidebar:
    st.link_button("Explore **Onco-AIDE**", "https://oncoai.org/aide")
    st.divider()
    st.write("**Created By:** Kavin Elangovan")
    st.write("**Model:** Custom EfficientNet")
...
if images:
    start_time = time.time() #Start timer here, before any image processing 
    ...
    end_time = time.time() #End timer here, after all image processing 
